...
/* ── Icons ── */
const HomeIcon = () => (
  <svg viewBox="0 0 24 24" width="9.5" height="9.5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const GitHubIcon = () => (
  <svg viewBox="0 0 24 24" width="9.5" height="9.5" fill="currentColor">
    ...
    >
        <motion.div
          ...
          >
            ...
            <div className="max-w-6xl mx-auto w-full flex items-start justify-between gap-6 md:gap-10">
              ...
              {/* Pages column */}
              <motion.div variants={itemVariants} className="pt-1 min-w-[90px] md:min-w-[110px]">
